...
@Mod(BeautifulOpalMod.MOD_ID)
public class BeautifulOpalMod {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "beautiful_opals";
...
//            }).build());
    ...
    public BeautifulOpalMod(IEventBus modEventBus, ModContainer modContainer) {
